<template lang="html">
  <Card :bordered="false">
      ...
      <ul class="icon_lists clear">
                ...
                <li>
                <i class="icon anticon icon-taobao-circle"></i>
                    <div class="name">taobao-circle</div>
                    <div class="fontclass">.icon-taobao-circle</div>
                </li>

                <li>
                <i class="icon anticon icon-weibo-circle"></i>
                    <div class="name">weibo-circle</div>
                    <div class="fontclass">.icon-weibo-circle</div>
                </li>

                <li>
                <i class="icon anticon icon-weibo-square"></i>
                    <div class="name">weibo-square</div>
                    <div class="fontclass">.icon-weibo-square</div>
                </li>

                <li>
                <i class="icon anticon icon-CodeSandbox"></i>
                    <div class="name">CodeSandbox</div>
                    <div class="fontclass">.icon-CodeSandbox</div>
                </li>

                <li>
                <i class="icon anticon icon-aliyun"></i>
                    <div class="name">阿里云</div>
                    <div class="fontclass">.icon-aliyun</div>
                </li>

                <li>
                <i class="icon anticon icon-zhihu"></i>
                    <div class="name">zhihu</div>
                    <div class="fontclass">.icon-zhihu</div>
                </li>

                <li>
                <i class="icon anticon icon-behance"></i>
                    <div class="name">behance</div>
                    <div class="fontclass">.icon-behance</div>
                </li>

                <li>
                <i class="icon anticon icon-dribbble"></i>
                    <div class="name">dribbble</div>
                    <div class="fontclass">.icon-dribbble</div>
                </li>

                <li>
                <i class="icon anticon icon-dribbble-square"></i>
                    <div class="name">dribbble-square</div>
                    <div class="fontclass">.icon-dribbble-square</div>
                </li>

                <li>
                <i class="icon anticon icon-behance-square"></i>
                    <div class="name">behance-square</div>
                    <div class="fontclass">.icon-behance-square</div>
                </li>

                <li>
                <i class="icon anticon icon-file-markdown"></i>
                    <div class="name">file-markdown</div>
                    <div class="fontclass">.icon-file-markdown</div>
                </li>

                <li>
                <i class="icon anticon icon-instagram"></i>
                    <div class="name">instagram</div>
                    <div class="fontclass">.icon-instagram</div>
                </li>

                <li>
                <i class="icon anticon icon-yuque"></i>
                    <div class="name">yuque</div>
                    <div class="fontclass">.icon-yuque</div>
                </li>

                <li>
                <i class="icon anticon icon-slack"></i>
                    <div class="name">slack</div>
                    <div class="fontclass">.icon-slack</div>
                </li>

                <li>
                <i class="icon anticon icon-slack-square"></i>
                    <div class="name">slack-square</div>
                    <div class="fontclass">.icon-slack-square</div>
                </li>
